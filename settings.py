...
DATABASES = {
    'default': {
        ...
        'NAME': 'ts',                      # Or path to database file if using sqlite3.
        'USER': 'postgres',                      # Not used with sqlite3.
        'PASSWORD': 'Quomarx456',                  # Not used with sqlite3.
...
SECRET_KEY = 'j=m2ex+zvg0r-9k*1gujq^9pa54vs(d4!62q6!edej2mbaukxh'
...
# AWS_STORAGE_BUCKET_NAME = 'timesheet'
